                    ...
                    <div class="row m-b-40">
                        <div class="col-lg-5">
                            <div class="product-image">
                                <!-- Carousel slider -->
                                <?php
                                if (mysqli_num_rows(mysqli_query($link,"SELECT id FROM product_images WHERE product_id='$productid' LIMIT 1"))>0){
                                    ?>
                                <div class="carousel dots-inside dots-dark arrows-visible" data-items="1" data-loop="true" data-autoplay="true" data-animate-in="fadeIn" data-animate-out="fadeOut" data-autoplay="2500" data-lightbox="gallery">
                                    <?php
                                        $col2=mysqli_query($link,"SELECT name as mname,id as mid,img_src as mimage FROM product_images WHERE product_id='$productid' ORDER BY id");
                                        
                                        while($row2=mysqli_fetch_array($col2)){ ?>
                                    <a href="<?php echo $row2['mimage'] ?>" data-lightbox="image" title="Shop product image!">
                                        <img alt="Shop product image!" src="<?php echo $row2['mimage'] ?>">
                                    </a>
                                <?php } ?>
                                </div>
                            <?php } else {
