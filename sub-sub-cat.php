...
<?php 
    ...
    $num_of_product=mysqli_query($link,"SELECT id FROM products WHERE sub_cat_2_id='$categoryid'")->num_rows;
                        ...
                        <div class="grid-item">
                            ...
                            <div class="product">
                                ...
                                <div class="product-image">
                                    ...
                                    <?php 
                                    $pro_col=mysqli_query($link,"SELECT id as pid,image as pimage FROM products WHERE sub_cat_2_id='$subcatid' ORDER BY id LIMIT 1");
                                    while($pro_row=mysqli_fetch_array($pro_col)){
                                    
                                    ?>

                                    <a href="shop?h=<?php echo $row['mid']; ?>"><img alt="Shop product image!" src="<?php echo $pro_row["pimage"]; ?>">
                                ...
                                <?php } ?>
                                   ...
                                   <!--  <a href="pro-door-window"><img alt="Shop product image!" src="assets/img/shop/2.Aluminium partition and doors-windows/pro1-1.jpg">
                                    ...
                                    <div class="product-overlay">
                                        ...
                                        <a href="shop?h=<?php echo $row['mid']; ?>">View</a>
                                ...
                                <div class="product-description">
                                    ...
                                    <div class="product-title">
                                        ...
                                        <h3><a href="shop?h=<?php echo $row['mid']; ?>"><?php echo $row["mname"]; ?></a></h3>
                    ...
                    <?php }else{
                        ...
                        <div class="grid-layout grid-3-columns" data-item="grid-item">
                                    ...
                                    <?php
                                            ...
                                            $col2 = mysqli_query($link,"SELECT name as pname,id as pid,image as pimage,slug as pslug FROM products WHERE sub_cat_1_id = '$categoryid' ORDER BY id");
