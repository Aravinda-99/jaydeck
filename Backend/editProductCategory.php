...
<head>
    ...
    <title>Edit Category - Modern Admin Panel</title>
                ...
                <div class="main-content-scroll">
                    ...
                    <div class="form-container">
                        <div class="form-header">
                            <h3>Edit Category #<?php echo $category['id']; ?></h3>
                        ...
                        <form method="POST" enctype="multipart/form-data" class="category-form">
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="description" name="description" rows="4" placeholder="Enter category description..."><?php echo htmlspecialchars($category['description']); ?></textarea>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="current-image">
                                    <p>Current Image:</p>
                                    <img src="../<?php echo htmlspecialchars($category['image']); ?>" alt="Current Category" class="current-category-image" onerror="this.src='https://placehold.co/200x150/6366f1/ffffff?text=No+Image'">
                                </div>
                                <?php endif; ?>
                    ...
                    <div class="form-container">
                        <div class="message error">
                            <?php echo $message ?: 'Category not found.'; ?>
                        </div>
                        <a href="productCategory.php" class="view-all-btn">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M15 18l-6-6 6-6"/></svg>
                            Back to All Categories
