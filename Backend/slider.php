...
<head>
    ...
    <style>
        ...
        *, *::before, *::after {
        ...
        .nav-accordion[open] > summary .chevron {
        ...
        th, td { padding: 0.75rem 1rem; vertical-align: middle; }
        thead tr { border-bottom: 1px solid var(--border-light); }
        th { font-weight: 600; color: #4b5567; }
        .dark th { color: #d1d5db; }
        tbody tr { border-bottom: 1px solid rgba(229, 231, 235, 0.5); transition: background-color var(--transition-speed); }
        .dark tbody tr { border-bottom: 1px solid rgba(55, 65, 81, 0.5); }
        tbody tr:last-child { border-bottom: none; }
        tbody tr:hover { background-color: #f9fafb; }
        .dark tbody tr:hover { background-color: rgba(55, 65, 81, 0.5); }
        td { color: #374151; }
        .dark td { color: #9ca3af; }
        .user-cell, .slider-cell { display: flex; align-items: center; }
        .user-cell img, .slider-cell img { width: 32px; height: 32px; border-radius: 50%; object-fit: cover; margin-right: 0.75rem; }
        .slider-cell img { border-radius: 0.25rem; width: 64px; height: 40px; }
        ...
        @media (min-width: 640px) {
            ...
            .profile-button span { display: inline; }
        }
        ...
        @media (min-width: 1024px) {
            ...
            .main-header .header-right { display: flex; }
    ...
    <div class="admin-panel">
        ...
        <aside class="sidebar" id="sidebar">
            ...
            <nav class="sidebar-nav">
                <a class="nav-link nav-item active" data-page="dashboard">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m3 9 9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>
                    <span>Dashboard</span>
                </a>
                <a class="nav-link nav-item" data-page="users">
                ...
                <details class="nav-accordion">
                    ...
                    <div class="submenu">
                        <a class="nav-link nav-item" data-page="add-slider">
                           <span>Add Slider</span>
                        </a>
                        <a class="nav-link nav-item" data-page="all-sliders">
                    ...
                    <div id="users-page" class="page-content hidden">
                         ...
                         <div class="table-container">
                             ...
                             <div class="table-wrapper">
                                 <!-- Users table from previous steps -->
                             </div>
                         </div>
                    </div>

                    <!-- Add Slider Page -->
                    <div id="add-slider-page" class="page-content hidden">
                        <div class="main-header"><h2>Add New Slider</h2></div>
                        <div class="form-container">
                            <form>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" id="slider-image" accept="image/*">
                                </div>
                                <div class="form-group">
                                    <label for="slider-description">Description</label>
                                    <textarea id="slider-description" placeholder="Enter a short description"></textarea>
                                </div>
                                <button type="submit" class="submit-btn">Add Slider</button>
                            </form>
                        </div>
                    </div>

                    <!-- All Sliders Page -->
                    <div id="all-sliders-page" class="page-content hidden">
                        <div class="main-header"><h2>All Sliders</h2></div>
                        <div class="table-container">
                             ...
                             <div class="table-wrapper">
                                 <table>
                                     ...
                                     <tbody>
                                         <tr>
                                             <td><div class="slider-cell"><img src="https://placehold.co/128x80/a5b4fc/1e1b4b?text=Slider+1" alt="Slider"></div></td>
                                             <td>Promotional Banner</td>
                                             <td><span class="status-badge status-active">Active</span></td>
                                             <td>2024-08-15</td>
                                         </tr>
                                         <tr>
                                             <td><div class="slider-cell"><img src="https://placehold.co/128x80/fca5a5/7f1d1d?text=Slider+2" alt="Slider"></div></td>
                                             <td>New Season Sale</td>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            navItems.forEach(item => {
                item.addEventListener('click', (e) => {
                    ...
                    if(parentAccordion) {
                        parentAccordion.querySelector('summary').classList.add('active');
                    }
